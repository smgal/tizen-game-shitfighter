#ifndef _SHITFIGHTERTIZEN_H_
#define _SHITFIGHTERTIZEN_H_
...
/**
 * [ShitFighterTizenApp] UiApp must inherit from UiApp class
 * which provides basic features necessary to define an UiApp.
 */
class ShitFighterTizenApp
...
public:
	ShitFighterTizenApp(void);
	virtual~ShitFighterTizenApp(void);
